...
export class PermissionLevelDetailComponent implements OnInit {
  permissionlevel$: Observable<String>;
  ...
  gotoPermissionLevels(permissionlevel: String) {
    let permissionLevelId = permissionlevel ? permissionlevel : null;
    this.router.navigate(['./admin/permission-levels', { id: permissionLevelId }]);
  }
}
